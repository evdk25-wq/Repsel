...
const HeaderBar: React.FC<HeaderBarProps> = ({ onOpen, onSave, onSaveAs, onExport, onClear, title = "Repsel" }) => {
  ...
  return (
    <header className="app-header" data-tauri-drag-region>
      ...
      <div className="header-actions">
        <button onClick={onOpen} className="header-tool" title="Ouvrir un document">
          <svg viewBox="0 0 20 20" aria-hidden="true">
            <path d="M3.5 5.5h4l1.5 2h7.5v7.25a1.75 1.75 0 0 1-1.75 1.75H5.25a1.75 1.75 0 0 1-1.75-1.75V5.5Z" />
            <path d="M3.5 8h13" />
          </svg>
        </button>
        <button onClick={onSave} className="header-tool header-tool-primary" title="Enregistrer">
          <svg viewBox="0 0 20 20" aria-hidden="true">
