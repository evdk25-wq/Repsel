...
const fr = {
  ...
  find: "Rechercher…",
  replace: "Remplacer…",
  findNext: "Poursuivre la recherche",
  findPrevious: "Chercher en arrière",
  ...
  fontPreview: "Aperçu",
  monospaceOnly: "Afficher seulement les polices à chasse fixe",
  apply: "Appliquer",
  language: "Langue",
  french: "Français",
  english: "English",
  ...
  sourceOnly: "Markdown uniquement",
  splitView: "Markdown et aperçu",
...
const en: Record<TranslationKey, string> = {
  ...
  fontPreview: "Preview",
  monospaceOnly: "Show monospace fonts only",
  apply: "Apply",
  language: "Language",
  french: "Français",
  english: "English",
  ...
  preview: "Preview",
  viewMode: "View mode",
  sourceOnly: "Markdown only",
  splitView: "Markdown and preview",
